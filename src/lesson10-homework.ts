...
function exercise42() {
  ...
  type TNumberPhone = TProduct['warehouse']['phoneNumbers'][0];
  function getProductWarehousePhoneNumber(product: TProduct): TNumberPhone {
...
function exercise44() {
  ...
  type TIsPrimitive<T> = T extends number | string | boolean
    ? 'primitive'
    : 'not primitive';
