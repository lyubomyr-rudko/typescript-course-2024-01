...
function exercise42() {
  ...
  type TPhoneNumber = TProduct['warehouse']['phoneNumbers'][number];
...
function exercise44() {
  ...
  // TODO uncomment the following lines
    type T1 = TIsPrimitive<number>; // 'primitive'
    type T2 = TIsPrimitive<string>; // 'primitive'
    type T3 = TIsPrimitive<0>;// 'primitive'
    type T4 = TIsPrimitive<{}>;  // not primitive'
    type T5 = TIsPrimitive<Function>;  // not primitive'
}
exercise44();
