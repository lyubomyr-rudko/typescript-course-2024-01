...
function exercise44() {
  ...
  // eslint-disable-next-line
  type TIsPrimitive<T> = T extends Primitive ? 'primitive' : 'not primitive';
...
function exercise45() {
  ...
  // Uncomment the following lines and make sure there are no errors
