...
function excerciseA() {
  ...
  interface IComputerBase {
    printConfiguration(): string;
  }
  class ComputerBase implements IComputerBase {
    constructor() {}
  ...
  class BaseDecorator implements IComputerBase {
    protected component: IComputerBase;

    constructor(component: IComputerBase) {
