...
function exercise31() {
  ...
  handleSaveUserSubmit2('Jack', 'Pitter');
  ...
  handleSaveUserSubmit3('Jack', 'Pitter', 'jp@some.com');
...
function exercise33() {
  ...
  //This line will cause an error as it tries to assign a string value to a number key
...
function exercise34() {
  ...
  const cachedResults: TAverageGrade = {};
