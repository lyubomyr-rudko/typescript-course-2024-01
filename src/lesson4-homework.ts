...
function exercise13A() {
  ...
  console.log(randomNumberFromArray([1, 5, 2, 9]));
  ...
  console.log(randomStringFromArray(['i', 'am', 'groot']));
  ...
  console.log(randomObjectFromArray([{ name: 'Tor' }, { name: 'Loki' }]));
  ...
  console.log(randomItemFromArray([9, 4, 6]));
  console.log(randomItemFromArray(['Hello', 'world']));
  console.log(randomItemFromArray([{ god: 1 }, { god: 2 }]));
  console.log(randomItemFromArray([1, 'home', { name: 'Alex' }]));
}
