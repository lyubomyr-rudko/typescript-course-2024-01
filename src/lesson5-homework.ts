...
function exercise18() {
  ...
  class Student {
    ...
    printStudent(): void {
      return console.log(
        `${this.name}  - ${this.age}  - id: ${this.studentId}`,
      );
    }
  }
  const person = new Student('Alex', 26, 4566436);
  person.age = 27;
  person.name = 'Artem';
  // person.studentId = 432423; error
}
...
function exercise19() {
  ...
  console.log(widgetWithSize.color);
  console.log(desktopWidget.os);
}
// TODO: compile and run the code
exercise19();
