...
function exercise18() {
  ...
  const student1 = new Student('Nikita', 21, 1);
  student1.printStudent();
  //student1.studentId = 2;//Erro
...
function exercise20() {
  function padLeft(value: string, n: string | number): string {
  ...
  //console.log(padLeft('hello', true)); // TODO: add compile time error //Error
}
// TODO: compile and run the code
...
function excerciseZ() {
  ...
  //https://github.com/NikitaDrzhevetskyi/ts-react-app
}
excerciseZ();
