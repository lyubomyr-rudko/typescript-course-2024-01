...
function excerciseA() {
  ...
  class WorkVisaApplication extends VisaApplication {
    protected step5(): void {
      console.log(
        'WorkVisaApplication has another realization of step5 from template class',
      );
    }
    protected step6(): void {
      console.log(
        'WorkVisaApplication has another realization of step6 from template class',
      );
    }
  }
  ...
  class TouristVisaApplication extends VisaApplication {
    protected step7(): void {
      console.log(
        'TouristVisaApplication has another realization of step7 from template class',
      );
    }
    protected step8(): void {
      console.log(
        'TouristVisaApplication has another realization of step8 from template class',
      );
    }
  }
  ...
  class StudentVisaApplication extends VisaApplication {
    protected step4(): void {
      console.log(
        'StudentVisaApplication has another realization of step4 from template class',
      );
    }
    protected step5(): void {
      console.log(
        'StudentVisaApplication has another realization of step5 from template class',
      );
    }
  }
