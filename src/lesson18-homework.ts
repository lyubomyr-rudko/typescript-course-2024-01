...
function excerciseA() {
  ...
  abstract class VisaApplication {
    public prepareDocuments(): void {
    ...
    protected getLocalPassportCopy(): void {
    ...
    protected getPoliceClearanceCertificate(): void {
    ...
    protected getBankStatement(): void {
    ...
    protected getEmploymentLetter(): void {
    ...
    protected getPropertyDocuments(): void {
    ...
    protected getInvitationLetter(): void {
    ...
    protected getTravelInsurance(): void {
    ...
    protected getFlightReservation(): void {
    ...
    protected getHotelReservation(): void {
    ...
    protected getVisaApplicationForm(): void {
  ...
  class WorkVisaApplication extends VisaApplication {
    getTaxReturns() {
      console.log('different implementation for step5');
    }
    getPropertyDocuments() {
      console.log('different implementation for step6');
    }
  }

  class TouristVisaApplication extends VisaApplication {
    getInvitationLetter() {
      console.log('different implementation for step7');
    }
    getTravelInsurance() {
      console.log('different implementation for step8');
    }
  }

  class StudentVisaApplication extends VisaApplication {
    getEmploymentLetter() {
      console.log('different implementation for step4');
    }
    getTaxReturns() {
      console.log('different implementation for step5');
    }
