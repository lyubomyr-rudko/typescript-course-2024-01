...
function excerciseA() {
  ...
  class WorkVisaApplication extends VisaApplication {
    step5() {
      console.log(
        'step 5 - Some different implementation of tax return for WORK VISA',
      );
    }

    step6() {
      console.log(
        'step 6 - Some different implementation of property documents fro WORK VISA',
      );
    }
  }
  ...
  class TouristVisaApplication extends VisaApplication {
    step7() {
      console.log('step 7 - Some another invitation letter for TOURIST VISA');
    }

    step8() {
      console.log('step 8 - Some another insurance for TOURIST VISA');
    }
  }

  class StudentVisaApplication extends VisaApplication {
    step4() {
      console.log('step 4 - Some different employment letter for STUDENT VISA');
    }

    step5() {
      console.log(
        'step 5 - Some different implementation of tax return for STUDENT VISA',
      );
    }
  }
